...
public abstract class PreferenceControllerFragment extends SettingsPreferenceFragment {
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        VnpttUntils.LogDebug(TAG, "onPreferenceTreeClick: " + preference.toString());
        Collection<AbstractPreferenceController> controllers = new ArrayList<>(mPreferenceControllers);
    ...
    protected <T extends AbstractPreferenceController> T getOnePreferenceController(
        ...
        final List<AbstractPreferenceController> foundControllers =
                mPreferenceControllers.stream().filter(clazz::isInstance).collect(Collectors.toList());
