...
public class AllAppsFragment extends SettingsPreferenceFragment implements
    ...
    private final Runnable mUpdateRunnable = new Runnable() {
        @Override
        public void run() {
            VnpttUntils.LogDebug(TAG, "mUpdateRunnable Run");
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        VnpttUntils.LogDebug(TAG, "onActivityCreated");
        ...
        mSessionInstalled = mApplicationsState.newSession(new RowUpdateCallbacks() {
            ...
            protected void doRebuild() {
                VnpttUntils.LogDebug(TAG, "doRebuild");
                rebuildInstalled();
            }
    ...
    private void updateAppListInternal(PreferenceGroup group, ArrayList<ApplicationsState.AppEntry> entries) {
        VnpttUntils.LogDebug(TAG, "updateAppListInternal");
        if (entries != null) {
    ...
    public boolean onPreferenceClick(Preference preference) {
        VnpttUntils.LogDebug(TAG, "onPreferenceClick" + preference.getKey());
