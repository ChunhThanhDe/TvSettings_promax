...
public class SoundModeFragment extends LeanbackPreferenceFragment implements Preference.OnPreferenceChangeListener, SeekBar.OnSeekBarChangeListener {
    ...
    private static int mCurrentSettingSourceId = AudioEffectManager.AUDIO_OUTPUT_DELAY_SOURCE_ATV;
    ...
    private void initOutputDelayAndPrescaleSeekBar(View view) {
        ...
        delayMs = mAudioEffectManager.getAudioOutputSpeakerDelay(mCurrentSettingSourceId);
        ...
        delayMs = mAudioEffectManager.getAudioOutputSpdifDelay(mCurrentSettingSourceId);
        ...
        int value = mAudioEffectManager.getAudioPrescale(mCurrentSettingSourceId);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        switch (seekBar.getId()) {
            ...
            case R.id.id_seek_bar_audio_delay_speaker:{
                ...
                mAudioEffectManager.setAudioOutputSpeakerDelay(mCurrentSettingSourceId, progress);
                setDelayEnabled();
                break;
            }
            case R.id.id_seek_bar_audio_delay_spdif:{
                setShow(R.id.id_seek_bar_audio_delay_spdif, progress);
                mAudioEffectManager.setAudioOutputSpdifDelay(mCurrentSettingSourceId, progress);
                setDelayEnabled();
                break;
            }
            case R.id.id_seek_bar_audio_prescale:{
                ...
                mAudioEffectManager.setAudioPrescale(mCurrentSettingSourceId, progress-150);
                setDelayEnabled();
                break;
            }
            default:
